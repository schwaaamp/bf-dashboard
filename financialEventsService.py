...
class FinancialEventsService:
    ...
    def getOrdersForDataframe(self, df, order_array):
    ...
    def getNextToken(self, detailedDf, order_array, financialEventGroupId):
    ...
    def getOpenPayments(self):
        ...
        for eventGroup in eventGroups:
            ...
            if(status == 'Open'):
                ...
                totalBalance = float(eventGroup['OriginalTotal']['CurrencyAmount'])
                ...
                order_array = self.getNextToken(detailedDf, order_array, financialEventGroupId)
